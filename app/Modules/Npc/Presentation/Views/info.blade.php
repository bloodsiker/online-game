                        ...
                        <div class="common-block common-block__red">
                            ...
                            <div class="bg-t">
                                <div class="common-header common-header__small">
                                    <div class="h-inner">
                                        <div class="h-txt">{{ $page->npc->name }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="common-content">
                                ...
                                <table width="490" border="0" cellspacing="0" cellpadding="0" class="mrg-top">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tbl-usi_bg" align="center" valign="middle" style="padding:4px;">
                                            <img src="{{ $page->npc->image }}" width="100%" alt="{{ $page->npc->name }}" border="0" style="display:block;width:100%;height:auto;">
                                        </td>
                                ...
                                <table width="490" border="0" cellspacing="0" cellpadding="0" class="mrg-top">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tbl-usi_bg" valign="top" style="padding:6px 4px;text-align:justify;">
                                            {!! nl2br(e((string) $page->npc->description)) !!}
                                        </td>
                                        <td class="tbl-usi_right">&nbsp;</td>
                                    </tr>
                                    <tr height="18">
                                ...
                                @if($page->npc->location && ! $page->npc->hide_location)
                                <table width="490" border="0" cellspacing="0" cellpadding="0" class="mrg-top">
                                    <tbody>
                                    <tr height="22">
                                        <td width="20" align="right" valign="bottom"><img src="{{ asset('img/bg/info/tbl-shp_sml-corner-top-left.gif') }}" width="20" height="22" alt></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tbl-usi_bg" valign="top" style="padding:6px 4px;">
                                            <table class="coll w100 p10h p2v brd2-all">
                                                <tbody>
                                                <tr class="bg_l">
                                                    <td class="brd2-top brd2-bt b">Расположение</td>
                                                    <td class="brd2-top brd2-bt b redd" align="right">{{ $page->npc->location->name }} [{{ $page->npc->location->id }}]</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </td>
