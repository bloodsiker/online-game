...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td class="tbl-shp-sml tt" valign="top" align="left">
            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="position: relative; top: 0px;">
                ...
                <tr height="21">
                    ...
                    <td width="2%" id="tab_1" align="center" style="background: url({{ asset($btnCenter1) }}) center top repeat-x; padding: 0px 2px 6px;">
                        <a id="center_1" href="{{ route('warehouse', ['id' => $page->warehouseId]) }}" title="Купить" class="btn_1">Оставить</a>
                    </td>
                    ...
                    <td width="2%" id="tab_2" align="center" style="background: url({{ asset($btnCenter2) }}) center top repeat-x; padding: 0px 2px 6px;">
                        <a id="center_2" href="{{ route('warehouse.take_item', ['id' => $page->warehouseId]) }}" title="Продать" class="btn_2">Забрать</a></td>
    ...
    <tr>
        ...
        <td class="tbl-usi_bg" valign="top" align="left" style="padding: 10 6 10 6">
            ...
            <form action="{{ route('warehouse.take_item', ['id' => $page->warehouseId]) }}" method="post">
                {{ csrf_field() }}
                    ...
                    @foreach($page->items as $item)
                        <tr height="17" class="brd2-top brd2 " align="center">
                            <td nowrap="" align="center" style="text-align: center" class="sell-item-checkbox">
                                <label for="checkbox-sell-{{ $item->itemId }}">
                                    <input type="checkbox" class="input-custom" name="item[{{ $item->itemId }}][selected]" value="1" id="checkbox-sell-{{ $item->itemId }}" />
