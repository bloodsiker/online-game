...
Route::get('/chat/world-events', [ChatController::class, 'worldEvents'])->name('chat.world-events');
Route::get('/chat/party-availability', [ChatController::class, 'partyAvailability'])->name('chat.party-availability');
