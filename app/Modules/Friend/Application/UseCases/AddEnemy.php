...
class AddEnemy
{
    ...
    public function execute(User $user, string $name): FriendActionResultDTO
    {
        ...
        $this->repository->firstOrCreateRelationship($playerId, $target->id, PlayerRelationshipType::ENEMY);

        return new FriendActionResultDTO(true, 'Добавлен в список врагов.', 'success');
    }
}
