...
class ClanTreasuryController extends Controller
{
    ...
    private function deposit(\App\Models\User $user, mixed $clan, mixed $clanWarehouse, int $amount): RedirectResponse
    {
    ...
    private function withdraw(\App\Models\User $user, mixed $clan, mixed $clanWarehouse, int $amount): RedirectResponse
    {
