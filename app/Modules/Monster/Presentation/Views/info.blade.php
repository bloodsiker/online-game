...
<head>
    ...
    <style>
        * { font-family: Tahoma, Geneva, sans-serif; font-size: 11px; }
        ...
        .common-block__red .corner-tl { background: url({{ asset('img/bg/info/common-block-red-tl.png') }}) 0 0 no-repeat; }
        ...
        .common-block__red .corner-tr { background: url({{ asset('img/bg/info/common-block-red-tr.png') }}) 0 0 no-repeat; }
        ...
        .common-block__red .corner-bl { background: url({{ asset('img/bg/info/common-block-red-bl.png') }}) 0 0 no-repeat; }
        ...
        .common-block__red .corner-br { background: url({{ asset('img/bg/info/common-block-red-br.png') }}) 0 0 no-repeat; }
        ...
        .common-header__small { position: relative; top: 11px; z-index: 1; height: 39px; padding: 0 0 0 87px; background: url({{ asset('img/bg/info/common-header-small.png') }}) 0 0 no-repeat; }
        .common-header__small .h-inner { height: 39px; padding: 0 97px 0 10px; background: url({{ asset('img/bg/info/common-header-small.png') }}) 100% -39px no-repeat; }
        ...
        .common-header__small .h-txt { padding: 10px 0 0; font-weight: 700; font-size: 11px; text-align: center; }
        ...
        .common-block__red .bg-inner-l { background: url({{ asset('img/bg/info/common-block-inner-red-l.png') }}) 0 0 repeat-y; }
        .common-block .bg-inner-r { background: url({{ asset('img/bg/info/common-block-inner-r.png') }}) 100% 0 repeat-y; }
        .common-block__red .bg-inner-r { background: url({{ asset('img/bg/info/common-block-inner-red-r.png') }}) 100% 0 repeat-y; }
        ...
        .tbl-shp_sml-top { background-image: url({{ asset('img/bg/info/tbl-shp_sml-top.gif') }}); background-repeat: repeat-x; height: 22px; font-size: 1px; }
        .tbl-usi_label-center { background-image: url({{ asset('img/bg/info/tbl-usi_label-center.gif') }}); background-repeat: repeat-x; height: 22px; font-family: Tahoma; font-weight: 700; font-size: 11px; color: #fcf5b7; padding-left: 10px; padding-right: 10px; padding-bottom: 3px; }
        .tbl-usi_left { background-image: url({{ asset('img/bg/info/tbl-usi_left.gif') }}); background-repeat: repeat-y; background-position: right; width: 20px; }
        .tbl-usi_bg { background-image: url({{ asset('img/bg/info/tbl-usi_bg.gif') }}); background-repeat: repeat; }
        .tbl-usi_right { background-image: url({{ asset('img/bg/info/tbl-usi_right.gif') }}); background-repeat: repeat-y; width: 20px; }
        .tbl-shp_sml-bottom { background-image: url({{ asset('img/bg/info/tbl-shp_sml-bottom.gif') }}); background-repeat: repeat-x; height: 18px; font-size: 1px; }
                        ...
                        <div class="common-block common-block__red">
                            ...
                            <div class="bg-t">
                                <div class="common-header common-header__small">
                                    <div class="h-inner">
                                        <div class="h-txt">{{ $page->monster->name }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table width="490" border="0" cellspacing="0" cellpadding="0" class="mrg-top">
                                    ...
                                    <tr height="22">
                                        ...
                                        <td class="tbl-shp_sml-top" valign="top" align="center">
                                            <table border="0" cellspacing="0" cellpadding="0"><tbody><tr height="22">
                                                <td><img src="{{ asset('img/bg/info/tbl-usi_label-left.gif') }}" width="27" height="22" alt></td>
                                                <td class="tbl-usi_label-center">Информация</td>
                                                <td><img src="{{ asset('img/bg/info/tbl-usi_label-right.gif') }}" width="27" height="22" alt></td>
                                            </tr></tbody></table>
                                        </td>
                                        <td width="20" align="left" valign="bottom"><img src="{{ asset('img/bg/info/tbl-shp_sml-corner-top-right.gif') }}" width="20" height="22" alt></td>
                                        ...
                                        <td class="tbl-usi_bg" valign="top" style="padding:6px 4px;">
                                            <table class="coll w100 p10h p2v brd2-all">
                                                ...
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                                    ...
                                                    <td class="brd2-top brd2-bt b redd" align="right">{{ $page->monster->lvl }}</td>
                                                </tr>
                                                @if($page->monster->hp)
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                                    <td class="brd2-top brd2-bt b">Жизнь</td>
                                                    <td class="brd2-top brd2-bt b redd" align="right">{{ $page->monster->hp }}</td>
                                                </tr>
                                                @endif
                                                @if($page->monster->min_dmg || $page->monster->max_dmg)
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                                ...
                                                @endif
                                                @if($page->monster->critical)
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                                    <td class="brd2-top brd2-bt b">Крит. удар</td>
                                                    <td class="brd2-top brd2-bt b redd" align="right">{{ $page->monster->critical }}</td>
                                                </tr>
                                                @endif
                                                @if($page->monster->exp)
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                                    <td class="brd2-top brd2-bt b">Опыт</td>
                                                    <td class="brd2-top brd2-bt b redd" align="right">{{ $page->monster->exp }}</td>
                                                </tr>
                                                @endif
                                                @if($page->monster->min_money || $page->monster->max_money)
                                                <tr class="{{ $row++ % 2 === 0 ? 'bg_l' : '' }}">
                                ...
                                <table width="490" border="0" cellspacing="0" cellpadding="0" class="mrg-top">
                                    ...
                                    <tr height="22">
                                        ...
                                        <td class="tbl-shp_sml-top" valign="top" align="center">
                                            <table border="0" cellspacing="0" cellpadding="0"><tbody><tr height="22">
                                                <td><img src="{{ asset('img/bg/info/tbl-usi_label-left.gif') }}" width="27" height="22" alt></td>
                                                <td class="tbl-usi_label-center">Возможные ценности</td>
                                                <td><img src="{{ asset('img/bg/info/tbl-usi_label-right.gif') }}" width="27" height="22" alt></td>
                                            </tr></tbody></table>
                                        </td>
                                        <td width="20" align="left" valign="bottom"><img src="{{ asset('img/bg/info/tbl-shp_sml-corner-top-right.gif') }}" width="20" height="22" alt></td>
                                        ...
                                        <td class="tbl-usi_bg" valign="top" style="padding:6px 4px;">
                                            <table class="coll w100 p10h p2v brd2-all">
                                                ...
                                                <tr class="{{ $loop->even ? 'bg_l' : '' }}">
                                                    ...
                                                    <td class="brd2-top brd2-bt redd" align="right" style="white-space:nowrap;">
                                                        @if($item->pivot->min_count != $item->pivot->max_count)
                                                            {{ $item->pivot->min_count }}–{{ $item->pivot->max_count }} шт.
                                                        @else
                                                            {{ $item->pivot->min_count }} шт.
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
