...
<head>
    <meta charset="UTF-8">
    <title>{{ $skill->name }} - информация о заклинании</title>
    <style>
        ...
        .bluu, .bluu * { color: #1a4d8a !important; }
...
<body class="regcolor">
@php
    $typeLabel = match ($skill->type) {
        'attack' => 'Атакующее заклинание', 'buff' => 'Усиление', 'debuff' => 'Ослабление',
        'heal' => 'Исцеление', 'defense' => 'Защитное заклинание', default => 'Вспомогательное заклинание',
    };
    $targetLabel = match ($skill->target_type) {
        'self' => 'На себя', 'all' => 'На союзников', 'enemy' => 'На противника', default => $skill->target_type,
    };
    $image = $skill->image ?: asset('img/icon/qst_default_start_new_m.gif');
    $light = true;
@endphp
                        ...
                        <div class="common-block common-block__red">
                            ...
                            <div class="bg-t">
                                <div class="common-header__small">
                                    <div class="h-inner">
                                        <div class="h-txt">Информация о заклинании</div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="bg-inner-t">
                                                    <div class="bg-inner-b">
                                                        <div class="common-content">
                                                            ...
                                                            {{-- ==== Окно 1: иконка + название + тип + уровень ==== --}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="tbl-usi_bg" valign="top" align="center">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                <td rowspan="4" valign="top" align="center" width="60">
                                                                                    <table width="60" height="60" cellpadding="0" cellspacing="0" border="0"
                                                                                           style="float: left; margin: 1px; background: url({{ $image }}) no-repeat center; background-size: cover;">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <td title="{{ $skill->name }}" valign="bottom">&nbsp;</td>
                                                                                        </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl-ati_brd-all">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="tbl-sts_bg-light">
                                                                                                <h1 style="display: inline; font-size: 11px; margin: 0;"><b>{{ $skill->name }}</b></h1>
                                                                                            </td>
                                                                                        </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td class="tbl-ati_regular" title="Тип заклинания"><img src="{{ asset('img/icon/tbl-shp_item-icon.gif') }}" width="11" height="10" class="tbl-shp_item-ico" alt="">{{ $typeLabel }}</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="tbl-ati_regular b" nowrap>
                                                                                    <span class="{{ $skill->is_passive ? 'bluu' : 'red' }}">{{ $skill->is_passive ? 'Пассивный навык' : 'Активный навык' }}</span>
                                                                                </td>
                                                                                <td>&nbsp;</td>
                                                                                <td>&nbsp;</td>
                                                                            </tr>
                                                            ...
                                                            {{-- ==== Окно 2: характеристики заклинания ==== --}}
                                                                    ...
                                                                    <td class="tbl-shp_sml-top" valign="top" align="center">
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr height="22">
                                                                                ...
                                                                                <td class="tbl-usi_label-center">Характеристики заклинания</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="tbl-usi_bg" valign="top" align="center">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl-ati_brd-all coll">
                                                                            ...
                                                                            <tr>
                                                                                <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Цель</b></td>
                                                                                <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $targetLabel }}</b></td>
                                                                            </tr>
                                                                            @php $light = ! $light; @endphp

                                                                            <tr>
                                                                                <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Уровень заклинания</b></td>
                                                                                <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $skill->level }}</b></td>
                                                                            </tr>
                                                                            @php $light = ! $light; @endphp

                                                                            @if(!$skill->is_passive)
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Расход маны</b></td>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $skill->mana_cost }}</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp

                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Кулдаун</b></td>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $skill->cooldown }} сек.</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                            @endif

                                                                            @if($skill->max_damage > 0)
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Базовый урон</b></td>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $skill->min_damage }}–{{ $skill->max_damage }}</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                            @endif

                                                                            @if($skill->power_coefficient > 0)
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Коэффициент силы</b></td>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ rtrim(rtrim(number_format($skill->power_coefficient, 2, '.', ''), '0'), '.') }}</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                            @endif
                                                                            ...
                                                                            @if($skill->base_healing > 0)
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom"><b>Базовое лечение</b></td>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px"><b class="tbl_red">{{ $skill->base_healing }}</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                            @endif
                                                                            ...
                                                                            @if($skill->requirements->isNotEmpty())
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" colspan="2"><b style="color:#8b4a00;">Требования к изучению:</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                                @foreach($skill->requirements as $requirement)
                                                                                    <tr>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" style="color: #8b4a00;">{{ $requirement->label() }}</td>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="color: #8b4a00; font-weight: bold; padding-right: 3px;">{{ $requirement->min_value }}</td>
                                                                                    </tr>
                                                                                    @php $light = ! $light; @endphp
                                                                                @endforeach
                                                                            @endif
                                                                            ...
                                                                            @if(!empty($skill->effects))
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" colspan="2"><b style="color:#3300ff;">Что даёт навык:</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                                @foreach($skill->effects as $effect)
                                                                                    <tr>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" style="padding-left: 15px;"><b>{{ \App\Modules\Clan\Domain\Enums\ClanSkillEffectType::tryFrom($effect['type'] ?? '')?->label() ?? ($effect['type'] ?? 'Бонус') }}</b></td>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px;"><b class="tbl_red">+{{ $effect['value'] ?? 0 }}{{ !empty($effect['is_percent']) ? '%' : '' }}</b></td>
                                                                                    </tr>
                                                                                    @php $light = ! $light; @endphp
                                                                                @endforeach
                                                                            @elseif($skill->skillEffects->isNotEmpty())
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" colspan="2"><b style="color:#3300ff;">Что даёт навык:</b></td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                                @foreach($skill->skillEffects as $effect)
                                                                                    <tr>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" style="padding-left: 15px;"><b>{{ $effect->name }}</b></td>
                                                                                        <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" align="right" style="padding-right: 3px;"><b class="tbl_red">{{ $effect->pivot->chance }}% · {{ $effect->pivot->duration_seconds }} сек.</b></td>
                                                                                    </tr>
                                                                                    @php $light = ! $light; @endphp
                                                                                @endforeach
                                                                            @endif
                                                                            ...
                                                                            @if($skill->description)
                                                                                <tr>
                                                                                    <td class="{{ $light ? 'tbl-sts_bg-light' : '' }} tbl-usi_brd-bottom" colspan="2">{{ $skill->description }}</td>
                                                                                </tr>
                                                                                @php $light = ! $light; @endphp
                                                                            @endif
