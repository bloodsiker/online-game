...
Route::get('/character/influence', [CharacterController::class, 'influence'])->name('character.influence');
Route::get('/character/influence/{map}', [CharacterController::class, 'influenceDetails'])
    ->whereNumber('map')
    ->name('character.influence.show');
