 ...
 * @property-read Location|null      $firstLocation
 * @property-read Location|null      $exitLocation
 * @property-read Location|null      $returnLocation
 * @property-read \Illuminate\Database\Eloquent\Collection<DungeonGate>    $gates
 * @property-read \Illuminate\Database\Eloquent\Collection<DungeonSession> $sessions
