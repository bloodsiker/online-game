...
class QuestPlayer extends Model
{
    ...
    /** Returns objectives belonging to the current active stage (or all if no stages). */
    ...
    public function isCurrentStageComplete(): bool
    {
        ...
        return $objectives->every(fn ($o) =>
            // deliver objectives are always "tracked" — actual check is via backpack at NPC
    ...
    {
        // Staged quest: completable at NPC only when there is no active stage left
