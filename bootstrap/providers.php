...
return [
    ...
    App\Modules\Location\LocationServiceProvider::class,
    App\Modules\MagicSkill\MagicSkillServiceProvider::class,
    App\Modules\Monster\MonsterServiceProvider::class,
    App\Modules\Npc\NpcServiceProvider::class,
    App\Modules\Player\PlayerServiceProvider::class,
    App\Modules\Quest\QuestServiceProvider::class,
    App\Modules\Race\RaceServiceProvider::class,
    App\Modules\Rating\RatingServiceProvider::class,
    App\Modules\Reputation\ReputationServiceProvider::class,
    App\Modules\Share\ShareServiceProvider::class,
    App\Modules\User\UserServiceProvider::class,
    App\Modules\Referral\ReferralServiceProvider::class,
