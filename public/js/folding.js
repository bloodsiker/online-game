...
// synops:
//		var instance_folding = new listFolding({id_btn: 'inst_btn_', id_expanded: 'inst_full_desc_', id_collapsed: 'inst_short_desc_'});
//		onclick = 'instance_folding.expand(55); return false;'
function gebi(id) {
    return document.getElementById(id)
}
function ListFolding(opt) {
    var defaults = {
        ...
        // be concat with `id`
        btn_expanded : 'img/icon/qst_minus.gif',
        btn_collapsed : 'img/icon/qst_plus.gif',
