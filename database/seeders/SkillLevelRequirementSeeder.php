 ...
 * РАЗНЫЙ опыт за удар в зависимости от оружия — 1 у стартового «Тесак
 * Головореза», 2 у всего, что дальше, см. StarterEquipmentSeeder::TIER1_SKILL_EXP_*):
 *  - skill 18 (гейт «Полуторный меч») должен требовать ~1850 опыта
