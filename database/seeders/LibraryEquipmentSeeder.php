    ...
    private const SETS = [
        1 => [
            [
                ...
                'description' => 'Универсальное снаряжение воина для уровней 1–20. Выберите оружие под развиваемый боевой навык; защитные ячейки комплекта открываются постепенно.',
                'items' => [
                    'Кастет новичка',
                    'Молот щитоносца',
                    'Булава стража',
