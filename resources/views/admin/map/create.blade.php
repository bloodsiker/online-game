...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="card">
                <div class="card-body">
                    <form action="{{ route('admin.map.create') }}" method="post" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="row form-group pb-3">
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" value="" placeholder="">
                                </div>

                                <div class="form-group">
                                    <label class="col-form-label" for="folder">Папка для карт</label>
                                    <input type="text" class="form-control" name="folder" id="folder" value="" placeholder="">
                                </div>
