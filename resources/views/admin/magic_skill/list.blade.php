        ...
        <div class="col-md-12">
            <section class="card">
                <div class="card-body">
                    ...
                    <form method="get" action="{{ route('admin.magic_skills') }}" class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-2"><div class="form-group"><label>Пассивность</label><select class="form-control" name="is_passive"><option value="">Все</option><option value="1" @selected($filters['is_passive'] === '1')>Пассивные</option><option value="0" @selected($filters['is_passive'] === '0')>Активные</option></select></div></div>
                            <div class="col-md-2 d-flex align-items-end"><div class="form-group"><button class="btn btn-primary btn-sm">Фильтровать</button> <a href="{{ route('admin.magic_skills') }}" class="btn btn-default btn-sm">Сбросить</a></div></div>
                        </div>
                    </form>
