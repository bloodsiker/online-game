                        ...
                        <table align="center" class="coll" cellpadding="0" cellspacing="0" style="margin:3px auto; width: 100%; ">
                            ...
                            <tr>
                                ...
                                <td class="c-s-n-fon" height="10">
                                    ...
                                    @php
                                        $cost = $itemEdit ? $itemEdit->item->itemInfo->price * $itemEdit->count : 0;
                                    @endphp
                                    ...
                                    <form id="new_message" method="post" action="{{ route('auction.my_lot.edit', ['id' => $auction->id, 'slotId' => $itemEdit->id]) }}">
                                        @csrf
                                                    ...
                                                    <table height="60" class="coll w100 p6h brd2-all" border="0">
                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td height="28" class="brd2-top brd2 b" align="right" nowrap="" style="padding-right: 11px;">
                                                                <input type="text" id="price"
                                                                       name="form[price]" value="{{ $itemEdit->price }}"
                                                        ...
                                                        <tr class="bg_l">
                                                            ...
                                                            <td height="28" class="brd2-top brd2 b" align="right" nowrap="">
                                                                <input type="text" id="amount"
                                                                       name="form[amount]" value="{{ $itemEdit->count }}"
                                                                       style="height:17px;width:75px;text-align:right"
                                                                       oninput="recalculate()"
                                                                       onkeyup="setTimeout('recalculate()', 10)"
                                                                       data-max-amount="{{ $itemEdit->count }}" class="dbgl2 brd b small">
                                                                <span>шт.</span>
                                                            </td>
                                                        </tr>
                                                        <tr class="">
                                                        ...
                                                        <tr class="bg_l">
                                                            ...
                                                            <td height="28" class="brd2-top brd2 b" align="left" nowrap="">
                                                                ...
                                                                <input type="checkbox" name="form[is_anonymous]" value="1" @if($itemEdit->is_anonymous) checked @endif title="Функция доступна для премиума от  уровня." id="_chk_0">&nbsp;<label for="_chk_0"></label><br>
                                                            </td>
                                                        </tr>
                                                        <tr class="">
                                                            ...
                                                            <td height="28" class="brd2-top brd2 b" align="left" nowrap="">
                                                                <input type="hidden" name="form[super]" value="">
                                                                <input type="checkbox" name="form[super]" value="1" id="super" @if($itemEdit->super) checked @endif onchange="recalculate();" title="Позиция таких заявок выше остальных.">&nbsp;<label for="_chk_1"></label><br>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td align="center" colspan="2">
                                                    ...
                                                    <span class="butt1 pointer">
                                                        <span>
                                                            <input value="Изменить" type="submit" onclick="if(document._submit)return false;document._submit=true;">
                                                        </span>
                                                    </span>
                                                    <span class="butt1 pointer">
                                                        <span>
                                                            <input value="Отменить" type="submit" onclick="if(document._submit)return false;window.location.href = '{{ route('auction.my_lot', ['id' => $auction->id]) }}';">
                                                        </span>
                                                    </span>
                                                </td>
                                            </tr>
