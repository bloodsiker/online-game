...
<table class="main-table" cellspacing="0" cellpadding="10" width="100%" height="100%">
    ...
    <tr valign="top">
        <td>
            Вы подошли к алтарю и, возложив на него руки, почувствовали, как энергия алтаря наполняет вас.  Вы восстановили <b>{{ $healHp }}</b> единиц здоровья
            @if($healMp) и <b>{{ $healMp }}</b> единиц маны  @endif
            ...
