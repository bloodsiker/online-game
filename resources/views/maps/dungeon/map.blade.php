...
<head>
    ...
    <script type="text/javascript">
        ...
        function show_alt() {
            var alive = 0;
            try { alive = top.obj.offsetParent } catch(e) {}
    ...
    <style>
        * { font-family: Tahoma, Geneva, sans-serif; font-size: 11px }
        ...
        .line-align { display: flex; align-items: center; gap: 3px; }
        .common-block { position: relative; }
        .common-block .corner-tl {
            position: absolute; top: -19px; left: -23px;
            width: 141px; height: 176px;
        ...
        .common-block .corner-br {
            position: absolute; bottom: -19px; right: -21px;
        ...
        .common-block .bg-t {
            height: 41px; margin: 0 39px; text-align: center;
        ...
        .common-header .h-txt {
            padding: 10px 0 0; font-weight: 700; font-size: 12px; text-align: center;
        }
        .common-header__small .h-txt {
            padding: 10px 0 0; font-weight: 700; font-size: 11px; text-align: center;
        }
        ...
        .tbl-shp_sml-top {
            ...
            background-repeat: repeat-x; height: 22px; font-size: 1px;
        }
        .tbl-usi_label-center {
            ...
            font-family: Tahoma; font-weight: 700; font-size: 11px; color: #fcf5b7;
            padding-left: 10px; padding-right: 10px; padding-bottom: 3px;
        }
        .tbl-usi_left {
            background-image: url({{ asset('img/bg/info/tbl-usi_left.gif') }});
            background-repeat: repeat-y; background-position: right; width: 20px;
        }
        .tbl-usi_bg {
        ...
        .tbl-shp_sml-bottom {
            ...
            background-repeat: repeat-x; height: 18px; font-size: 1px;
        }
        ...
        <div class="common-block common-block__red">
            ...
            <div class="bg-t">
                <div class="common-header common-header__small">
                    <div class="h-inner">
                        <div class="h-txt">Тёмное Подземелье</div>
                    </div>
                </div>
            </div>
            <div class="bg-l"><div class="bg-r"><div class="bg-inner">
            <div class="bg-inner-l"><div class="bg-inner-r"><div class="bg-inner-t">
            <div class="bg-inner-b"><div class="common-content">
                ...
                <tr>
                    ...
                    <td class="tbl-usi_bg" valign="top" style="padding:6px 4px; overflow-x:auto;">
                        @include('maps.dungeon.frame')
                    </td>
