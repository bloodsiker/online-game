                                                                                    ...
                                                                                    <table class="coll w100 p10h p2v brd2-all">
                                                                                        ...
                                                                                        <tr class="bg_l">
                                                                                            <td class="brd2-top brd2-bt b">
                                                                                                <span class="line-align" onclick="mark_l(6,2)"
                                                                                                      onmouseover="mark_l(6,1)"
                                                                                        ...
                                                                                        <tr class=>
                                                                                            <td class="brd2-top brd2-bt b">
                                                                                                <span class="line-align" onclick="mark_l(101,2)"
                                                                                                      onmouseover="mark_l(101,1)"
