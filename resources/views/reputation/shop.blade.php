...
<head>
    ...
    <title>Магазин — {{ $reputation->name }}</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" style="position: relative; top: 0px;">
    ...
    <tr height="21">
        ...
        <td width="100" align="center" style="background: url({{ asset($btnCenter2) }}) center top repeat-x; padding: 0px 2px 6px;">
            <a href="{{ route('reputation.index', $reputation->id) }}" class="btn_2">← Репутация</a>
        </td>
                                ...
                                <td class="tbl-shp-sml tt" valign="top" align="center">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr height="22">
                                            ...
                                            <td align="center" class="tbl-usi_label-center">Магазин — {{ $reputation->name }}</td>
                                    ...
                                    <table class="coll w100 p6h p2v brd2-all">
                                        ...
                                        <tr class="bg_l">
                                            <td class="brd2-top brd2-bt" colspan="3" style="padding: 5px 10px;">
                                                Ваши очки репутации: <b>{{ $pr->points }}</b>
                                            </td>
                                        </tr>

                                        @forelse($reputation->shopItems as $shopItem)
                                            @php $locked = $pr->points < $shopItem->min_points; @endphp
                                            <tr class="{{ $locked ? 'bg_l' : 'bg_l' }}" @if(!$locked) onmouseover="this.className='bg_l2'" onmouseout="this.className='bg_l'" @endif>
                                                ...
                                                <td class="brd2-top brd2-bt" align="right">
                                                    ...
                                                    @else
                                                        <form method="POST"
                                                              action="{{ route('reputation.buy', [$reputation->id, $shopItem->id]) }}"
                                        ...
                                        <tr class="bg_l"
                                            onclick="location.href='{{ route('reputation.index', $reputation->id) }}'"
                    ...
                    <td valign="top" width="202" height="100%">
                        <table width="240" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr height="22">
                                ...
                                <td class="tbl-shp-sml tt" valign="top" align="center">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr height="22">
                                            <td width="27"><img src="{{ asset('img/bg/info/tbl-usi_label-left.gif') }}" width="27" height="22"></td>
                                            <td align="center" class="tbl-usi_label-center">{{ $reputation->npc->name ?? $reputation->name }}</td>
                                            <td width="27"><img src="{{ asset('img/bg/info/tbl-usi_label-right.gif') }}" width="27" height="22"></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tbl-usi_bg" valign="top" style="padding: 4px 0 4px 0">
                                    @if($reputation->icon)
                                        <img src="{{ asset($reputation->icon) }}" alt="{{ $reputation->name }}" width="190">
                                    @elseif($reputation->npc && $reputation->npc->icon)
                                        <img src="{{ asset($reputation->npc->icon) }}" alt="{{ $reputation->npc->name }}" width="190">
                                    @endif
                                    @if($reputation->description)
                                        <div class="p2v" style="padding: 4px 6px;">{{ $reputation->description }}</div>
                                    @endif
                                </td>
                                <td class="tbl-shp-sides rs">&nbsp;</td>
                            </tr>
